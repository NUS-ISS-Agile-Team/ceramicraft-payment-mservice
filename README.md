...
This service is part of the **cerami-craft** project, responsible for payment-related APIs.
...
2.  **Build and run services:**
    ...
    *The Swagger will be available at `http://localhost/payment-ms/v1/swagger/index.html`.*